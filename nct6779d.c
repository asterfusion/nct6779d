...
static s32 sio_smbus_access(struct i2c_adapter *adapter, u16 addr, unsigned short flags, char read_write, u8 command, int size, union i2c_smbus_data *data)
{
    ...
    switch (size) {
        ...
        case I2C_SMBUS_BYTE_DATA:
            ...
            /* When reset assert, the data from the slave is unreachable. A negative value as an indicator will be reutrned to caller to help ignore the data.
             * by tsihang, 2023-05-06. */
#if 1
